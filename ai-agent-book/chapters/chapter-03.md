...
```text
src/mini_agent/tools/AgentTool/AgentTool.tsx
...
```text
main.tsx -> QueryEngine.ts -> query.py
```
...
```text
query.py -> toolExecution.ts -> tool.py -> 某个具体工具
```
...
```text
BashTool.tsx -> bashPermissions.py -> useCanUseTool.tsx -> utils/permissions
```
...
```text
AgentTool.tsx -> runAgent.py -> tools.py -> query.py
```
